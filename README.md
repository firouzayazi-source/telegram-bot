...
لینک‌های داخل متن یک بخش با «✨ ساخت دکمه از لینک‌های متن» (در صفحه‌ی دکمه‌های
همان بخش) به دکمه‌ی inline تبدیل می‌شوند و عنوان فارسی می‌گیرند — اینستاگرام،
تلگرام، بله، ایتا، روبیکا، واتساپ، آپارات، یوتیوب و… ؛ دامنه‌ی خود فروشگاه
(`SHOP_SITE`) «🌐 وب‌سایت فروشگاه» می‌شود.

پس از آن، همان لینک‌ها **از متن پنهان می‌شوند** (`strip_button_links`) چون دکمه
جایشان را گرفته. مثل لینک نقشه، این کار **غیرمخرب** است: متن اصلی در
